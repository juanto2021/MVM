 ...
 * @author Frank Hilken
 */
public class ModelValidatorConfigurationWindowJuanto extends JDialog {
	...
	private class ValidateActionListener implements ActionListener {
		...
		public void actionPerformed( ActionEvent e ) {
			if (settingsConfiguration.isChanged()) {
				int result = JOptionPane.showConfirmDialog(ModelValidatorConfigurationWindowJuanto.this,
	...
	public ModelValidatorConfigurationWindowJuanto(final JFrame parent, final IModel model, final String useFile) {
...
//		setVisible(true);
	...
	private JMenuBar buildMenuBar() {
		...
		openMenuItem.addActionListener( new ActionListener() {
			...
			public void actionPerformed( ActionEvent e ) {
				...
				if (fileChooser.showOpenDialog(ModelValidatorConfigurationWindowJuanto.this) == JFileChooser.APPROVE_OPTION) {
	...
	private String readNewConfigurationName(String dialogMessage, String suggestedValue) {
		...
		String error = null;
		do {
			newName = JOptionPane.showInputDialog(ModelValidatorConfigurationWindowJuanto.this, (error == null? "" : error) + dialogMessage, suggestedValue);
