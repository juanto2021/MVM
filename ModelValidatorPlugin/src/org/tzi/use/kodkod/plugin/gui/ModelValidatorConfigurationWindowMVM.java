 ...
 * @author Frank Hilken
 */
public class ModelValidatorConfigurationWindowMVM extends JDialog {
	...
	private class ValidateActionListener implements ActionListener {
		...
		public void actionPerformed( ActionEvent e ) {
			if (settingsConfiguration.isChanged()) {
				int result = JOptionPane.showConfirmDialog(ModelValidatorConfigurationWindowMVM.this,
	...
	public ModelValidatorConfigurationWindowMVM(final JFrame parent, final IModel model, final String useFile) {
...
//		setVisible(true);
	...
	private JMenuBar buildMenuBar() {
		...
		openMenuItem.addActionListener( new ActionListener() {
			...
			public void actionPerformed( ActionEvent e ) {
				...
				if (fileChooser.showOpenDialog(ModelValidatorConfigurationWindowMVM.this) == JFileChooser.APPROVE_OPTION) {
	...
	private String readNewConfigurationName(String dialogMessage, String suggestedValue) {
		...
		String error = null;
		do {
			newName = JOptionPane.showInputDialog(ModelValidatorConfigurationWindowMVM.this, (error == null? "" : error) + dialogMessage, suggestedValue);
